...
interface TestERC20Interface extends ethers.utils.Interface {
  functions: {
    ...
    "__TestERC20_init(string,string)": FunctionFragment;
    "allowance(address,address)": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "burn(uint256)": FunctionFragment;
    "burnFrom(address,uint256)": FunctionFragment;
    "burnWithoutApproval(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "__TestERC20_init",
  ...
  encodeFunctionData(
    functionFragment: "burnWithoutApproval",
    values: [string, BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setupDecimals",
    values: [BigNumberish]
  ): string;
