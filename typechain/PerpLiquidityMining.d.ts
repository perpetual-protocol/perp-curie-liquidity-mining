...
interface PerpLiquidityMiningInterface extends ethers.utils.Interface {
  functions: {
...
export class PerpLiquidityMining extends BaseContract {
  ...
  interface: PerpLiquidityMiningInterface;
